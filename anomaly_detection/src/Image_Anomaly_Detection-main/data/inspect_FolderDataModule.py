...
dataset_root = "/root/src/Image_Anomaly_Detection-main/dataset/festo2/"
...
datamodule = Folder(
    ...
    train_batch_size=1, # default value
    eval_batch_size=1, # default value
    image_size=(960,250)
)
...
datamodule.train_data.samples.to_csv(os.path.join("/root/src/Image_Anomaly_Detection-main/data", "datamodule_train.csv"), index=False)
datamodule.test_data.samples.to_csv(os.path.join("/root/src/Image_Anomaly_Detection-main/data", "datamodule_test.csv"), index=False)
datamodule.val_data.samples.to_csv(os.path.join("/root/src/Image_Anomaly_Detection-main/data", "datamodule_val.csv"), index=False)
...
#                 grid=False,
#                 title_fontsize=20,
#                 path_image="/root/src/Image_Anomaly_Detection-main/resources/examples_images.png")