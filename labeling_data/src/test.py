...
absolutepath_of_directory_with_xmlfiles = './train/'  #　It is okay to have a mix of xml files and images in the same directory.
absolutepath_of_directory_with_imgfiles = './train/'
absolutepath_of_directory_with_yolofiles = './train/'  # Yolo files will be created under this directory.
absolutepath_of_directory_with_classes_txt = './train/'  # You do not need to create classes.txt. classes.txt will be generated automatically.
absolutepath_of_directory_with_error_txt = './error/'  # The names of files that do not have a paired xml or image file will be written to a text file under this directory.
